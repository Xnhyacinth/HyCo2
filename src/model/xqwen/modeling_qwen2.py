...
from transformers import (AutoConfig, AutoModel, AutoTokenizer, Qwen2Config,
                          Qwen2ForCausalLM)
...
class XQwen2ForCausalLM(Qwen2ForCausalLM):
    def __init__(self, config):
        ...
        **kwargs,
        ...
        if not at_the_beginning_of_generation:
            ...
            if retriever_input_ids is not None:
                ...
                # except:
                #     print("retriever_input_ids.dtype: ", retriever_input_ids.dtype)
                #     retrieval_outputs = super().forward(
                #         input_ids=retriever_input_ids.to(torch.int64),
                #         attention_mask=doc_attention_mask,
                #         output_hidden_states=True,
                #     )
